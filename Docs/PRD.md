...
claimed_by: uuid (foreign key to users.id)
...
CREATE TABLE locations (
  id: uuid (primary key)
  name: text                    -- "São Paulo"
  slug: text (unique)           -- "sao-paulo-sp-br"
  type: text                    -- 'city', 'state', 'country'
  parent_id: uuid (nullable)    -- Foreign key to parent location
  country_code: text            -- "br", "us"
  state_code: text              -- "sp", "ca" (nullable for countries)
...
('loc-1', 'Brazil', 'brazil-br', 'country', NULL, 'br', NULL, NULL),
('loc-2', 'São Paulo', 'sao-paulo-sp-br', 'state', 'loc-1', 'br', 'sp', NULL),
('loc-3', 'São Paulo', 'sao-paulo-sp-br', 'city', 'loc-2', 'br', 'sp', point(-23.5505, -46.6333));
```

#### Location Slug Generation Logic
...
const generateLocationSlug = (location: LocationSlug): string => {
  const nameSlug = slugify(location.name);
  
  switch (location.type) {
    case 'country':
      return `${nameSlug}-${location.countryCode}`;
    
    case 'state':
      return `${nameSlug}-${location.stateCode}-${location.countryCode}`;
...
// Examples:
// generateLocationSlug({ name: "São Paulo", type: "city", countryCode: "br", stateCode: "sp" })
// Result: "sao-paulo-sp-br"
```

#### Multiple Location Pages per Category

**Each category generates multiple location pages:**

```
/digital-marketing/brazil-br          → "Best Digital Marketing in Brazil"
/digital-marketing/sao-paulo-sp-br    → "Best Digital Marketing in São Paulo"
/digital-marketing/rio-de-janeiro-rj-br → "Best Digital Marketing in Rio de Janeiro"
```
...
```
/digital-marketing/brazil-br
/digital-marketing/sao-paulo-sp-br
/digital-marketing/rio-de-janeiro-rj-br
/digital-marketing/minas-gerais-mg-br
/digital-marketing/belo-horizonte-mg-br
```

**Future International Expansion:**
```
/digital-marketing/united-states-us
/digital-marketing/california-ca-us
/digital-marketing/san-francisco-ca-us
/digital-marketing/new-york-ny-us
/digital-marketing/manhattan-ny-us
```
...
3. System checks if user meets Spotlight requirements:
   - Must be Verified tier or higher
...
### 5. Signal Feature (Priority: Low - Not in MVP)
...
**Future Phase: Signal Feature**

* Key Deliverables: Signal creation, matching algorithm, provider notifications, messaging system, admin moderation tools.

* Dependencies: All MVP phases completed and platform proven.
